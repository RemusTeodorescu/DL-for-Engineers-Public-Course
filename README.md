...
This repository holds the student-facing material: the lecture slides as PDF and
the exercise sets as Colab-ready notebooks. It is generated from the course's
development repository and refreshed after every change, so it is always current.
...
- `lectures/L02.2-pytorch-and-autograd/`
- `lectures/L03.1-what-is-ai/`
- `lectures/L03.2-ai-application-examples/`
- `lectures/L04.1-perceptron-to-neural-network/`
- `lectures/L04.2-deep-neural-networks/`
- `lectures/L05.1-convolutional-and-graph-networks/`
- `lectures/L05.2-sequences-and-attention/`
- `lectures/L06.1-loss-functions-and-gradients/`
- `lectures/L06.2-post-training/`
- `lectures/L07.1-fundamentals-of-pinns/`
- `lectures/L07.2-fundamental-pdes/`
- `lectures/L08.1-stationary-heat/`
- `lectures/L08.2-dynamic-heat-transfer/`
- `lectures/L09.1-laminar-flow/`
- `lectures/L09.2-turbulent-flow/`
- `lectures/L10.1-ionic-diffusion/`
- `lectures/L10.2-solid-oxide-cells/`
- `lectures/L11.1-vision-based-navigation/`
- `lectures/L11.2-dynamics-energy/`
- `lectures/L12.1-power-grid-stability-estimation/`
- `lectures/L12.2-power-grid-stability-prediction/`
- `lectures/_template/`

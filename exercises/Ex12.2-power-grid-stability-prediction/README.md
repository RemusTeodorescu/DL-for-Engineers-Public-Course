...
`Ex12.2_outputs/`. On Google Colab every notebook runs on its own temporary machine,
...
folder to `MyDrive/DL4Eng/Ex12.2_outputs`. If the student declines the Drive request or
